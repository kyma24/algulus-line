...
const StartSection = () => {
  return (
    <div>
        <div className={`${styles.layered} top-[30vh] w-1/2 max-w-[450px] opacity-30`} />
        <div className={`${styles.layered} top-[32.5vh] w-7/12 max-w-[525px] opacity-50`} />
        <div className={`${styles.layered} ${styles.mainSection} top-[35vh] w-2/3 max-w-[600px] text-center`}>
            <div>
